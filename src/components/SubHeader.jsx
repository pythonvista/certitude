...
function SubHeader({ title, img }) {
  return (
    <section>
      ...
      <div
        className={`${img} h-[180px] grid place-items-center bg-cover font-poppins font-bold text-2xl md:text-3xl lg:text-4xl text-white w-full bg-no-repeat text-center`}
      >
        <h4>{title}</h4>
      </div>
    </section>
